...
feature_list = ["3.tanBeta","4.mGluino", "5.mcL"]
...
kernel_matern = C(10, (1e-3, 1e3)) * Matern(np.array([10, 1.0]), (1e-4, 1e6), nu=1.5) + C(0.001, (1e-6,1e5))
...
kernel_ell3 = C(1.0, (1e-2, 1e8)) * RBF(np.array([10, 10, 1.0]), (1e-4, 1e4)) + C(0.001, (1e-6,1e5))
...
elif my_kernel == 'kernel_ell3': my_kernel = kernel_ell3
else:
