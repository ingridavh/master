...
# Change to norm=True to include Gaussian approx
plt.hist(errors_GP_new, normed = True, bins= n_bins, histtype='step', linewidth=2)
plt.hist(errors_DGP_new, normed = True, bins= n_bins, histtype='step', linewidth=2)
