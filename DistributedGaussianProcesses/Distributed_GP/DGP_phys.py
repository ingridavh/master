...
#Small number
eps = 1E-30 # Used to regularize points with zero cross section
...
my_dgp.fit_and_predict(features_q, target, trainsize=trainsize, alpha=0.01)
