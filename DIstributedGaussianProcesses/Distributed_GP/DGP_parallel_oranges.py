...
python DGP_parallel_oranges.py trainsize outfile kernel experts nodes
...
data_lin = pd.read_csv('/home/ingrid/Documents/Master/ML/Abel_lin_log_60k/data_60k.dat', sep=' ', skipinitialspace=True)
